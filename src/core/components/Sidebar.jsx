...
export default function Sidebar2({ className = "", user, handleLogout }) {
  ...
  return (
    <>
      <div
        id="sidebar"
        className={`transition-all duration-200 p-4 relative bg-white rounded-xl ml-4 mt-4 mb-4 shadow-lg border border-gray-200 
      ...
      >
        ...
        <div className="absolute bottom-6 left-0 w-full flex flex-col items-center gap-2">
          <Link
            ...
            className={`btn btn-ghost flex flex-row items-center gap-4 px-4 py-10 w-auto min-w-[60px] max-w-xs${
              collapsed
          ...
          <button
            ...
            className={`btn btn-outline btn-primary w-52 mt-1 ${
